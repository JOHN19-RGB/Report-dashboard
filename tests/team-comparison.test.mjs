...
const dev = { tasks: [devTask("imp", "Imp"), devTask("imp", "Imp"), devTask("not", "Not bug/imp"), devTask("bug", "Bug"), devTask("bug2", "Bug"), devTask("open", "Bug", "2026-05-01", { status: { done: false } }), devTask("prev-year", "Bug", "2025-05-01"), devTask("missing", "Bug", null, { closedDate: "2026-05-01" })], syncedAt: "2026-09-18T01:00:00Z", taskPartial: false };
